...
function getWorldSpaceHalfWidth(camera, distance, resolution): number {
...
function raycastWorldUnits(lineSegments, intersects): void {
...
function raycastScreenSpace(lineSegments, camera, intersects): void {
...
class InstancedLineSegments2 extends InstancedMesh2 {
  /**
   ...
   */
  constructor(geometry: LineSegmentsGeometry, material: LineMaterial, params?: InstancedMesh2Params) {
   ...
   */
  override raycast(raycaster: Raycaster, intersects: Intersection<Object3D>[]): void {
